            ...
            <div className='space-y-6 rounded-xl bg-white p-6 shadow-sm'>
                <div className='space-y-2'>
                    ...
                    <p className='text-base leading-relaxed text-gray-700'>
                        Mokku es una plataforma modular que impulsa el desarrollo de soluciones digitales modernas,
                        rápidas y eficientes. Ayuda a equipos a construir apps escalables con componentes reutilizables
                        y buenas prácticas desde el día uno.
                    </p>
                </div>
                ...
                <p className='text-center text-sm text-gray-500'>Construido con ♥ por el equipo Mokku — 2025</p>
            </div>
        )
    },
    render: (args) => (
